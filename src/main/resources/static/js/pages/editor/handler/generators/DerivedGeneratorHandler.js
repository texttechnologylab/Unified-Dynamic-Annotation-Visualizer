...
export default class DerivedGeneratorHandler extends FormHandler {
  static token = "DG";
  static description = "Description of the DerivedGenerator generator.";
  static defaults = {
